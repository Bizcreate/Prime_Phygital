              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="flex flex-col items-center gap-2">
                    <div
                      className="h-20 w-full rounded-md bg-gradient-to-r from-neon-purple to-neon-blue border border-white/20 cursor-pointer"
                      onClick={() => {
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div
                      className="h-20 w-full rounded-md bg-gradient-to-r from-neon-green to-neon-blue border border-white/20 cursor-pointer"
                      onClick={() => {
                        // Handle theme selection
                        console.log("Selected ocean theme")
                      }}
                    ></div>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div
                      className="h-20 w-full rounded-md bg-gradient-to-r from-neon-purple to-neon-red border border-white/20 cursor-pointer"
                      onClick={() => {
                        // Handle theme selection
                        console.log("Selected sunset theme")
                      }}
                    ></div>
            ...
            <CardFooter>
              <Button
                ...
                onClick={() => {
                  ...
                  console.log("Saving appearance preferences")
                }}
              >
                Save Preferences
              </Button>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={true}
                    onCheckedChange={(checked) => {
                      console.log("Product scans notifications:", checked)
                    }}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={true}
                    onCheckedChange={(checked) => {
                      console.log("New customers notifications:", checked)
                    }}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={true}
                    onCheckedChange={(checked) => {
                      console.log("Security alerts notifications:", checked)
                    }}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      console.log("Marketing updates notifications:", checked)
                    }}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      console.log("Copying production API key")
                    }}
                  >
                    Copy
                  </Button>
                  <Button
                    ...
                    className="border-white/10"
                    onClick={() => {
                      console.log("Regenerating production API key")
                    }}
                  >
                    Regenerate
                  </Button>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="border-white/10"
                    onClick={() => {
                      console.log("Copying test API key")
                    }}
                  >
                    Copy
                  </Button>
                  <Button
                    ...
                    className="border-white/10"
                    onClick={() => {
                      console.log("Regenerating test API key")
                    }}
                  >
                    Regenerate
                  </Button>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="border-white/10"
                    onClick={() => {
                      console.log("Saving webhook URL")
                    }}
                  >
                    Save
                  </Button>
